...
public class HomeworkEx3 {
	...
	public static void main(String[] args) {
		...
		/* 사이트에서 회원 관리(로그인, 회원 가입, 등)을 위한 Member 클래스를 작성하세요. */
		
		// 작성한 Member 클래스를 이용하여 인스턴스를 생성하고 구현한 메서드를 테스트 해보세요.
		// 아이디와 비번이 없는 인스턴스 생성
		Member mem1= new Member();
		mem1.print();
		// 아이디와 비번이 없는 인스턴스이기 때문에 아이디 abc 와 비번 def로  비교하면 false
		System.out.println(mem1.equals("abc", "def"));
		
		// 아이디가  abc, 비번이 def, 이메일이 abc@naver.com 인 인스턴스 생성
	...
	class Member{
		...
		// equals :아이디와 비번이 주어지면 내 정보와 같은지 다른지 알려주는 메서드
		...
		//생성자: 기본 생성자, 아이디 와 비번 와 이메일이 필요한 생성자, 아이디와 비번이 필요한 생성자
